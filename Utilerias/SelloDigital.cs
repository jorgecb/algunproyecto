...
namespace Utilerias
{
    public class SelloDigital
    {
        public string Sellar(string CadenaOriginal, string ArchivoClavePrivada, string lPassword)
        {
            ...
            RSACryptoServiceProvider lrsa = OpenSslKey.opensslkey.DecodeEncryptedPrivateKeyInfo(ClavePrivada, lSecStr);
        ...
        /// <summary>
        /// Lee el código del certificado enviado este como matriz de bytes
        /// </summary>
